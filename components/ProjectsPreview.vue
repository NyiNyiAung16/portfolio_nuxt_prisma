...
<template>
    <section class="block md:block px-6 py-14 transition-colors duration-500 darkMode">
        <div>
            <div class="text-center space-y-3">
                <h2 class="font-bold text-3xl sm:text-4xl md:text-6xl dark:text-white">My Projects</h2>
                <p class="text-md sm:text-xl md:text-3xl dark:text-gray-300 text-opacity-95">Examples of my projects completed</p>
            </div>
