...
<template>
    <div class="py-5">
        ...
        <div class="mt-5" v-if="project && !loading">
            <div class="w-[80%] bg-[#eaeaea] rounded mx-auto pb-10">
                ...
                <div class="mt-7 px-6">
                    ...
                    <div class="mt-3">
                        <span class="font-medium">Youtube Link</span> - <NuxtLink href="#" class="underline">{{ project.youtube_link }}</NuxtLink>
                    </div>
                    <div class="flex items-center gap-3 mt-4 text-sm">
                        <div v-for="tag in project.tags" :key="tag" class="inline-block px-3 py-2 rounded-md bg-[#fff] select-none">
                            {{ tag }}
                        </div>
                    </div>
                </div>
